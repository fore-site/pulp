...
const rimrafPosixDir = async (path, opt, ent) => {
    ...
    const removedAll = (await Promise.all(entries.map(ent => rimrafPosixDir(resolve(path, ent.name), opt, ent)))).every(v => v === true);
    if (!removedAll) {
        return false;
    }
...
//# sourceMappingURL=rimraf-posix.js.940b35854c1d.map